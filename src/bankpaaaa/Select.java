...
public class Select extends JFrame implements ActionListener{
	...
	public Select(){	
		ImageIcon background = new ImageIcon("src/select.jpg");
        ...
        d.setBounds(480, 60, 220, 100);
        d.addActionListener(this);
        d.setOpaque(false);
        d.setFont(new Font("微软雅黑",Font.PLAIN,25));
        ...
        d2.setBounds(600, 60, 220, 100);
        d2.addActionListener(this);
        d2.setOpaque(false);
        d2.setFont(new Font("微软雅黑",Font.PLAIN,25));
        ...
        // 第三行
        m = new JButton("修改密码");
        m.setBounds(430, 340, 220, 100);
        m.addActionListener(this);
        m.setOpaque(false);
        m.setFont(new Font("微软雅黑",Font.PLAIN,25));
        ...
        if (!MainFrame.privelege.equals("个人客户")){
        del = new JButton("销户");
        del.setBounds(600, 340, 220, 100);
        del.addActionListener(this);
        del.setOpaque(false);
        del.setFont(new Font("微软雅黑",Font.PLAIN,25));
        ...
        cuscreate.setBounds(770, 340, 220, 100);
        cuscreate.addActionListener(this);
        cuscreate.setOpaque(false);
        cuscreate.setFont(new Font("微软雅黑",Font.PLAIN,25));
        cuscreate.setForeground(new Color(0,0,0));
        ...
        clerkcreate.setBounds(940, 340, 220, 100);
        clerkcreate.addActionListener(this);
        clerkcreate.setOpaque(false);
        clerkcreate.setFont(new Font("微软雅黑",Font.PLAIN,25));
        clerkcreate.setForeground(new Color(0,0,0));
        ...
        help.setBounds(430, 480,220, 100);
        help.addActionListener(this);
        help.setOpaque(false);
        help.setFont(new Font("微软雅黑",Font.PLAIN,25));
        help.setForeground(new Color(0,0,0));
        help.setContentAreaFilled(false);
        help.setFocusPainted(false);
        
        about = new JButton("关于");
        about.setBounds(600,480, 220, 100);
