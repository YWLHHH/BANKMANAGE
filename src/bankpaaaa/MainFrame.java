...
public class MainFrame extends JFrame implements ActionListener{	
	...
	public static String privelege;
	public static String name;
    public static int Locatewidth = (Toolkit.getDefaultToolkit().getScreenSize().width - 1120) / 2;
    public static int Locateheight = (Toolkit.getDefaultToolkit().getScreenSize().height - 630) / 2; 
    
    public MainFrame(){
    	// 设置背景图片
    	ImageIcon background;
        background = new ImageIcon("src/login.jpg");
        ...
        yesBtn.setBounds(485, 425, 70, 30);
        ...
        cancelBtn.setBounds(600, 425, 70, 30);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == cancelBtn) {
          ...
          if (cardTextField.getText().trim().equals("")) {
        	new Notify(null, "USERNAME NULL!");
        	return;
          }
          else if (passwordSTR.equals("")) {
            new Notify(null, "PASSWORD NULL!");
            return;
          }
          String strSQL;
          ...
          if (!isExist) {
        	  new Notify(null, "ID/PASSWORD ERROR!");
          }
          else {
            try {
              rs.first();
