...
import bankpaaaa.DBManager;
import bankpaaaa.MainFrame;
...
public class AccountAdd extends JFrame implements ActionListener {
  ...
  public AccountAdd(String privilege) {
    ...
    nameTextField.setBounds(615, 208, 200, 25);
    ...
    String infob = "";
    try {
    	String strSQL = "select balance from deposit where card='11111111'";
  ...
  public static void main(String[] args) {
	AccountAdd accountAdd = new AccountAdd("个人客户");
}
}
