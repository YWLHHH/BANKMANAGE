...
public class Deposit extends JFrame implements ActionListener {
  ...
  public Deposit() {
    ...
    background = new ImageIcon("src/deposit.jpg");
    ...
    try {
    	...
    	String strSQL = "select balance from deposit where card='22222222'";
  ...
  public void actionPerformed(ActionEvent e) {
	if (e.getSource() == exitBtn) {
      ...
      String privtemp = "", stattemp = "";
         try {
    	  //String strSQL = "select privelege,status from account where card='1111111'";
        	 String strSQL = "select privelege,status from account where card='2222222'";
          rs = db.getResult(strSQL);
          rs.first();
      ...
      if (cardTextField.getText().trim().equals("")) new Notify(null, "卡号不能为空！");
        ...
        try {
        	//strSQL= "select balance from deposit where card='1111111' order by ddate";  
        	strSQL= "select balance from deposit where card='22222222' order by ddate";  
